...
import { TTrack, TTransformedTracks } from 'entities/track/model/types';
...
it('should transform tracks according to utcOffsetInMinutes argument', () => {
  const res = transformTracks({ ...defaultArg, utcOffsetInMinutes: -300 }, mockTracks);
