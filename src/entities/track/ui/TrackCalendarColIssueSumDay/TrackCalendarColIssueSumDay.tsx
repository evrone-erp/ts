...
import { useAddNewTrackAction } from 'entities/track/lib/hooks/use-add-new-track-action';
...
import { comparePropsWithTracks } from 'entities/track/lib/compare-props-with-tracks';
